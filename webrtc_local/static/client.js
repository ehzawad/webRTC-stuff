...
function send_message(){
    ...
    x = xhr.open('GET', 'http://192.168.10.92:5025/message?sender='+sender+'&output=' + encodeURIComponent(output), true);
    ...
    xhr.onreadystatechange = function() {
      if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
        ...
        // console.log("AUDIO DATA: ", audio1.ended)
        // $("#output").val("");
      }
    };
...
function starter(){
    ...
    start();
    // console.log("Stopper count: ", stopper_cnt)
...
function stop() {
    ...
    setInterval(function (){
        if(audio1.ended){
            console.log("Inside audio ended")
            starter();
        }
    }, 500);
}
