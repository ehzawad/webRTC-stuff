...
vosk_interface = os.environ.get('VOSK_SERVER_INTERFACE', '192.168.10.92')
...
async def message(request):
    ...
    sender_data = '{"sender":"'+sender+'","message":"'+output+'","cli": "12346798","metadata":"bn"}'
    
    post_data = sender_data.encode('utf-8')
    # print(post_data)
    req = rqst.Request("http://192.168.10.92:5005/webhooks/rest/webhook", data=post_data)
...
if __name__ == '__main__':
    ...
    web.run_app(app, port=vosk_port, host="192.168.10.92", ssl_context=ssl_context)
